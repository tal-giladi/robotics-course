...
- **02.05-E2:** (1) with 5 % resistors, 2.2 k/3.3 k gives a worst corner of **3.27 V** (1 k/1.5 k is the same ratio and the same corner); 1 k/2 k reaches 3.61 V and fails the 3.3 V requirement. With 1 % resistors the same 2/3 ratio still peaks at **3.52 V** — over 3.3 V — so the **ratio**, not the tolerance, is the problem; 2.2 k/3.3 k at 1 % peaks at 3.18 V. (2) the worst low corner is **2.73 V**, a $V_{IH}$ margin of **0.73 V**; load 5.25/5500 = **0.95 mA**. (3) 100 k/22 k gives 12.6 × 22/122 = **2.27 V** at a full pack and 1.62 V at the 9.0 V cutoff — a 0.65 V span, about **806 counts** of the 12-bit ADC, plenty; the worst 5 % corner at 12.6 V is **2.47 V**, far below 3.3 V. (4) at 12.9 V with 1 % resistors the corners are 2.29–2.37 V: still safe. The 100 k/22 k divider has margin precisely because its ratio is conservative — and it costs **103 µA** of permanent battery drain, which is the trade you made.
