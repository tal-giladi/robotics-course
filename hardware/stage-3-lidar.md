...
| ROS 2 driver | **Best in class.** Official `rplidar_ros` has apt binaries on Jazzy (arm64 included), and the C1 launch file is in its changelog: https://index.ros.org/p/rplidar_ros/ . Alternative source build: `sllidar_ros2` (launch `view_sllidar_c1_launch.py`), https://github.com/Slamtec/sllidar_ros2 . |
