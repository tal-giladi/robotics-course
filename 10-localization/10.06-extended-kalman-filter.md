...
- https://doi.org/10.1109/9.978374 — Julier & Uhlmann, *Unscented filtering and nonlinear estimation*: what to use when the linearization of Exercise E5 is no longer good enough. `robot_localization` ships this as `ukf_node`.
